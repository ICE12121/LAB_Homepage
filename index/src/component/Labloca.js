...
const Lablocal = () => {
    ...
    <div className="container px-5 my-5">
        <div className="text-center mb-5">
                    <h1 className="display-5 fw-bolder mb-0"><span className="text-gradient d-inline">本研究室への案内</span></h1>
        </div>
        <div className="d-flex flex-coloum text-left mb-5">
        <iframe
    ...
    ></iframe>
    <div className='m-3'>
    <p className="lead fw-light mb-4">本研究室は福岡工業大学のD棟5階にあります.</p><br/>
    <b>所在地:</b><br/>
